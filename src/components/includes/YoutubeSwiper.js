        ...
        >
          <SwiperSlide>
            <a href={`https://www.youtube.com/watch?v=${swiper[0].id}`}>
              <img
                src={`https://i.ytimg.com/vi/${swiper[0].id}/hqdefault.jpg`}
          ...
          <SwiperSlide>
            <a href={`https://www.youtube.com/watch?v=${swiper[1].id}`}>
              <img
                src={`https://i.ytimg.com/vi/${swiper[1].id}/hqdefault.jpg`}
          ...
          <SwiperSlide>
            <a href={`https://www.youtube.com/watch?v=${swiper[2].id}`}>
              <img
                src={`https://i.ytimg.com/vi/${swiper[2].id}/hqdefault.jpg`}
          ...
          <SwiperSlide>
            <a href={`https://www.youtube.com/watch?v=${swiper[3].id}`}>
              <img
                src={`https://i.ytimg.com/vi/${swiper[3].id}/hqdefault.jpg`}
          ...
          <SwiperSlide>
            <a href={`https://www.youtube.com/watch?v=${swiper[4].id}`}>
              <img
                src={`https://i.ytimg.com/vi/${swiper[4].id}/hqdefault.jpg`}
          ...
          <SwiperSlide>
            <a href={`https://www.youtube.com/watch?v=${swiper[5].id}`}>
              <img
                src={`https://i.ytimg.com/vi/${swiper[5].id}/hqdefault.jpg`}
          ...
          <SwiperSlide>
            <a href={`https://www.youtube.com/watch?v=${swiper[6].id}`}>
              <img
                src={`https://i.ytimg.com/vi/${swiper[6].id}/hqdefault.jpg`}
          ...
          <SwiperSlide>
            <a href={`https://www.youtube.com/watch?v=${swiper[7].id}`}>
              <img
                src={`https://i.ytimg.com/vi/${swiper[7].id}/hqdefault.jpg`}
          ...
          <SwiperSlide>
            <a href={`https://www.youtube.com/watch?v=${swiper[8].id}`}>
              <img
                src={`https://i.ytimg.com/vi/${swiper[8].id}/hqdefault.jpg`}
